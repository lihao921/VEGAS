...
# torchaudio.set_audio_backend("soundfile") # in official videollava
# pip install soundfile
torchaudio.set_audio_backend("soundfile")  # in original languagebind
...
class LanguageBindAudioProcessor(ProcessorMixin):
    ...
    # add for inference time preprocess
